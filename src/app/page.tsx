...
export default function Home() {
  ...
  return (
    <div className="min-h-screen font-sans">
      <section className="relative flex min-h-[60vh] w-full items-center overflow-hidden bg-black sm:min-h-[75vh] md:min-h-[90vh]">
        {!videoLoadFailed ? (
          <video
            key={HERO_VIDEO_SRC}
            ref={videoRef}
        ...
        <div className="relative z-20 mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 sm:py-12">
          <div className="max-w-xl">
            <h1 className="font-sans text-4xl font-extrabold italic leading-tight tracking-tight text-[#FF9A4D] drop-shadow-[0_3px_8px_rgba(0,0,0,0.55)] sm:text-5xl md:text-6xl">
              Your Love, Our Care
            </h1>
          </div>
        </div>
