...
export default function AboutSection({
  ...
  paragraph2 = (<>  Themed Excursions at New Farm Bistro <br/>
  Pack the bus and head to the beautiful New Farm Bistro. We host your group for a 1.5+ hour immersive experience including a gourmet meal and a live themed performance.  </>),
  paragraph3 = (<><strong> Bollywood Bash:</strong> Vibrant Indian flavors and rhythmic classics.<br/>
    <strong>French Bastille Day:</strong> A gourmet journey to Paris through food and song.<br/>
    <strong>Mexican Fiesta:</strong> Festive tunes and a menu that brings the heat (just enough!).  </>),
  paragraph4 = (<> In-House Incursions<br/>
Can’t make it to the Bistro? We’ll bring the magic to you. Valerie prepares a chef-standard meal to be served at your facility, while Sandra sets the stage with a live set of classics tailored to your residents' favorite eras.   </>),
  ...
  return (
    <section className="w-full min-h-screen  bg-white py-10 dark:bg-zinc-950  sm:py-16 ">
